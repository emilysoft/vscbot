    ...
    const result = await this.db.run(
      `INSERT INTO events
       (server_id, name, description, role_id, channel_id, custom_message,
        ...
        text_channel_name, channel_topic, voice_channel_name, image_url, require_confirmation, is_private, send_events_channel_msg, events_channel_message_id,
      ...
      data.events_channel_message_id ?? null,
